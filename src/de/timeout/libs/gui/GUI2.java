...
import de.timeout.libs.gui.GUI.GUICloseEvent;
...
public class GUI2 {
	 ...
	 * @param design
	 */
	public GUI2(@Nonnull Inventory design) {
		this(design, Material.GRAY_STAINED_GLASS_PANE);
	}
	
	public GUI2(@Nonnull Inventory design, Material background) {
		this(design, background, null);
	}

	
	public GUI2(@Nonnull Inventory design, Material background, Consumer<GUICloseEvent> event) {
		// Validate
